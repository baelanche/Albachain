...
export CA3_KEY=$(ls crypto-config/peerOrganizations/org3.hydrogreen.com/ca/ | grep _sk)

docker-compose -f docker-compose.yml down

# docker-compose -> 컨테이터수행 및 net_basic 네트워크 생성
docker-compose -f docker-compose.yml up -d ca.org1.hydrogreen.com ca.org2.hydrogreen.com ca.org3.hydrogreen.com orderer.hydrogreen.com peer0.org1.hydrogreen.com  peer0.org2.hydrogreen.com peer0.org3.hydrogreen.com couchdb1 couchdb2 couchdb3 cli
docker ps -a
docker network ls
